...
export default function DashboardHomePage() {
    return (
        <div className="space-y-6">
            ...
            {/* Fila 1: Tarjetas de Métricas (Grid de 3 columnas) */}
            ...
            {/* Fila 2: Gráficos y Globo Decorativo */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">

                {/* Espacio para futuro gráfico de red (Ocupa 2 columnas) */}
           ...
           <span className="text-zinc-600 font-mono">
             [ Future Traffic Analysis Chart Area ]
                ...
                {/* Widget del Globo Decorativo (Ocupa 1 columna) */}
                <div className="lg:col-span-1 h-[400px] rounded-xl border border-zinc-800 bg-black overflow-hidden relative flex items-center justify-center group shadow-lg">
                    ...
                    {/* Aquí le pasamos un tamaño fijo (ej. 350px) para que actúe como widget */}
                    <div className="absolute top-8">
                        <CyberGlobe widgetSize={380} />
                    </div>

                    {/* Gradiente para difuminar los bordes del globo dentro de la tarjeta */}
