                        ...
                        <div className="flex items-start gap-4 relative z-10">
                            ...
                            <div className="flex-1 w-full">
                                ...
                                {isLoading && !user ? (
                                    ...
                                    <div className="mt-4 p-4 text-sm font-mono text-zinc-500 border border-zinc-800 border-dashed rounded bg-zinc-950/30">Data unavailable.</div>
                                )}
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div className="p-4 bg-zinc-950/80 border border-zinc-800/50 rounded-lg flex flex-col items-center justify-center text-center gap-2 relative overflow-hidden">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-[10px] text-zinc-500 font-mono uppercase tracking-wider">Firewall Engine</p>
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <p className={`text-xs font-bold font-mono uppercase ${status.firewall ? 'text-emerald-400' : 'text-red-400'}`}>{status.firewall ? 'ACTIVE' : 'DISABLED'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-4 bg-zinc-950/80 border border-zinc-800/50 rounded-lg flex flex-col items-center justify-center text-center gap-2">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-[10px] text-zinc-500 font-mono uppercase tracking-wider">DHCP Service</p>
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <p className={`text-xs font-bold font-mono uppercase ${status.dhcp ? 'text-emerald-400' : 'text-zinc-500'}`}>{status.dhcp ? 'RUNNING' : 'STOPPED'}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-4 bg-zinc-950/80 border border-zinc-800/50 rounded-lg flex flex-col items-center justify-center text-center gap-2">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-[10px] text-zinc-500 font-mono uppercase tracking-wider">Interfaces</p>
                                    ...
                                    <div className="p-4 bg-zinc-950/80 border border-zinc-800/50 rounded-lg flex flex-col items-center justify-center text-center gap-2">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-[10px] text-zinc-500 font-mono uppercase tracking-wider">Routing Table</p>
