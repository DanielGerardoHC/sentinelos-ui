        ...
        <div className="space-y-6 relative overflow-hidden">
            ...
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                <SheetContent
                    ...
                    className="bg-[#09090b] border-l border-zinc-800 text-zinc-100 sm:max-w-[550px] w-full p-0 flex flex-col h-full transition-all duration-300 ease-in-out z-[50]"
                >
