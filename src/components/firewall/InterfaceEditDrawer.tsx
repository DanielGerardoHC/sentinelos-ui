        ...
        <>
            <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
                <SheetContent
                    ...
                    style={{ right: isZoneDrawerOpen ? '500px' : '0px' }}
                    // Lo hicimos más ancho: max-w-[500px]
                    className="bg-[#09090b] border-l border-zinc-800 text-zinc-100 sm:max-w-[500px] w-full p-0 flex flex-col h-full transition-all duration-300 shadow-2xl shadow-black z-[60]"
                >
