...
export function RouteEditDrawer({ isOpen, onClose, routeData, onSuccess }: RouteEditDrawerProps) {
    const { saveRoute, isLoading } = useRoutes();
    ...
    // Estado para la cascada del panel de interfaces
    ...
    // Preparamos las opciones para el ResourceSelector
    ...
    return (
        <>
                    ...
                    <div className="p-6 space-y-6 flex-1 overflow-y-auto">
                        <div className="space-y-3">
                            ...
                            <Input
                                ...
                                className="bg-zinc-950 border-zinc-800 text-emerald-400 font-mono h-11 focus-visible:ring-emerald-500/50"
                                placeholder="e.g. 0.0.0.0/0 (Default Route) or 10.50.0.0/24"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-3">
                                <Label className="text-zinc-500 font-mono text-xs uppercase">Administrative Distance (Metric)</Label>
                                <Input
                                    type="number"
                                    value={formMetric}
                                    onChange={(e) => setFormMetric(e.target.value ? Number(e.target.value) : '')}
                                    className="bg-zinc-950 border-zinc-800 text-emerald-400 font-mono h-11 focus-visible:ring-emerald-500/50"
                                    placeholder="10"
                                />
                            </div>
                        ...
                        {/* El selector con el lápiz mágico */}
                        <ResourceSelector
                            label="Egress Interface"
                            value={formInterface}
                            onChange={setFormInterface}
                            options={interfaceOptions}
                            onEditClick={() => setIsInterfaceDrawerOpen(true)}
                        />
                        ...
                        <div className="space-y-3">
                            ...
                            <Input
                                ...
                                className="bg-zinc-950 border-zinc-800 text-zinc-300 font-mono h-11 focus-visible:ring-emerald-500/50"
                                placeholder="e.g. Route to Branch Office"
                            />
                        </div>
                    </div>
            ...
            {/* Componente de cascada para editar la interfaz de salida seleccionada */}
